...
useEffect(() => {
  ...
  async function  Load()
  {
     const result = await axios.get(
         "http://localhost:8080/api/v1/customer/getAllCustomer");
    ...
    try
        {
         await axios.post("http://localhost:8080/api/v1/custmor/save",
        {
   ...
   {
        await axios.delete("http://localhost:8080/api/v1/custmor/deleteCustomer/" + customerid); 
   ...
   try
       {
        await axios.put("http://localhost:8080/api/v1/customer/updateCustomers/",
       {
